...
class browsing_tests(unittest.TestCase):
    ...
    def test_sanity(self):
        ...
        self.wait_time = 15
        self.build_number = UpdateEnvironment.build_number
        self.headless_mode = 0
        self.chrome_driver_path = UpdateEnvironment.chrome_driver_path
        self.firefox_driver_path = UpdateEnvironment.firefox_driver_path
        self.admin_address = UpdateEnvironment.admin_address
        self.shield_ip = UpdateEnvironment.shield_ip
        self.shield_machine_user = UpdateEnvironment.shield_machine_user
        self.shield_machine_pass = UpdateEnvironment.shield_machine_pass
        self.branch = UpdateEnvironment.branch
        ...
        Functions.ConfigNewEnvAdmin('chromedriver', self.chrome_driver_path, 'OFF', self.headless_mode,
...
if __name__ == '__main__':
    unittest.main()
    # unittest.mai
    # n(testRunner=HtmlTestRunner.HTMLTestRunner(output=".", report_name= 'Update Env Sanity Test Report', add_timestamp=True,report_title='Update Env Sanity Test Report'))