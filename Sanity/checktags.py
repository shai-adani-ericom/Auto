...
excludedImages=[]
excludedImagesAdditional=['esNodeGroupsScaler','esBrowserScheduler','esLdapApi','esShieldCLI','esExternalDNS'] # Added by Shai
if "unused-images" in valuefile:
    ...
    excludedImages=['esNodeGroupsScaler','esBrowserScheduler','esLdapApi','esShieldCLI']

excludedImages.append('esExternalDNS')
print(excludedImages)
